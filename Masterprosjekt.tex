...
\newcommand{\thesisTitle}{Investigating the effect of a robotic presence compared to virtual simulation in teaching angles and turn measurements to children
}
