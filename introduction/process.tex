...
In this chapter we will first present the process and planning of the initial review. Then to aid the reader we've included a short introduction to the theory of constructionism, as this was used in the majority of research within education robotics. 
Then, in section~\ref{ch:stateOfArt}, we'll present the results from our review.
