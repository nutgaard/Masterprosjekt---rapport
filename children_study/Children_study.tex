...
\begin{document}
	...
	this is the view where most of the programming will be done.
	And where programming is done by dragging \textit{codeblocks} to their correct place.
	As an alternative to the \textit{graphics view}, there is also a \textit{textual view}(see figure~\ref{fig:extendedTextual}). 
	The \textit{textual view} provides the same functionality as the \textit{graphics view}, but requires you to write the code yourselves.
