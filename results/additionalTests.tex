\section{Additional analyses}\label{ch:additionalTests}
...
\smalltable{Group statistics for gains when grouping by pretest score, with outliers.}{table:score}{
...
\smalltable{Group statistics for gains when grouping by pretest score, without outliers.}{table:scoreNoOutlier}{
	\begin{tabular}{lllll}\hline
		Group & N & Difference mean & Std. Deviation & Std. Error Mean\\\hline
