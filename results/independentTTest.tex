\chapter{Independent-samples t-test}\label{ch:independentttest}
...
\section{Assumptions regarding study design}\label{sec:assumptionStudy}
...
\subsection{Testing for outliers}\label{sec:outliers}
...
\smalltable{Results of independent t-test. * outlier removed}{table:fullIndependeny}{
	\begin{tabular}{llllll}
		Varable & t & df & Sig. & Mean diff & Std. Error Diff\\\hline
