\chapter{Reliability measures}\label{ch:cronbach}
...
\section{Test-retest correlations}
In order to measure the stability reliability we used the Pearson's product-monent correlations between the pretest scores and posttest scores. The initial analysis showed indicated that the relationship to be linear with both variables normally distributed(Shapiro-Wilk, $p > 0.05$). 
